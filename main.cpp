...
int main(){
	...
	do{
		...
		cout << "Digite o numero da funcao desejada(valor 0 interrompe a execucao): ";
		cin >> funcao;
		...
		switch(funcao){
			...
			case 6://filtrar imoveis de acordo com a cidade inserida
				...
				//	cout << **i;
				//}
				for(unsigned int i = 0; i <  imoveis_retorno.size(); i++)//printar os imoveis da cidade inserida
					cout << *imoveis_retorno.at(i);
				imoveis_retorno.clear();
			break;
